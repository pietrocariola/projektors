...
# constants
DS_PATH = "/home/gpu1/datasets/PlantDoc-Dataset"

def get_prompt(conv_mode):

    if conv_mode=="default":
        prompt_start = "<image>\nHuman: Classify this image into one of the following categories relating to plant leaf diseases:"
        prompt_end = ". Only output a single final classification label and NOTHING ELSE.\n\n Output:"
    
    elif conv_mode=="instructblip":
        prompt_start = "<image>Question: Can you classify this image into one of the following categories relating to plant leaf diseases:"
