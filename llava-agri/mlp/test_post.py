...
eval_ds = CustomDataset(processor, split='test', conv_mode='llava')
...
# auxiliary model
input_size = model.config.text_config.max_position_embeddings
output_size = len(labels_list)
cls = PrePostProjCls2(input_size, output_size)
