from ...datasets.agri import CustomDataset
from ...models.llava import CustomModel
from ...models.transformer_cls import PrePostProjCls
...
dataset = CustomDataset(processor, split='train', val_pct=VAL_PCT, conv_mode='llava')
...
for i in range(N_SAMPLES):
    ...
    input_size_pre = model.config.vision_config.hidden_size
    ...
    # auxiliary model size
    input_size_post = model.config.text_config.max_position_embeddings
    hidden_size_post = model.config.vision_config.hidden_size
    ...
    # POST -------------------------------------
    # reload aux model
    cls_post = PrePostProjCls2(input_size_post, hidden_size_post, output_size_post)
